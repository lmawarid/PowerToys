...
namespace Microsoft.PowerToys.Settings.UI.Lib.ViewModels
{
    public class FancyZonesViewModel : Observable
    {
        ...
        private static string ToRGBHex(string color)
        {
            try
            {
                // Using invariant culture as these are expected to be hex codes.
                int argb = int.Parse(color.Replace("#", string.Empty), System.Globalization.NumberStyles.HexNumber, CultureInfo.InvariantCulture);
